     ...
     public function Consulter()
     {
         ...
         public function add_Client(){
             if ($this->Logged_in() == 0)
                 ...
                 $this->form_validation->set_rules('activite','', 'trim|required|min_length[1]|max_length[50]');
                 $this->form_validation->set_rules('ape','', 'trim|required|min_length[1]|max_length[50]|numeric');
                 $this->form_validation->set_rules('raisonsocial','', 'trim|required|min_length[1]|max_length[50]');
                 $this->form_validation->set_rules('adresselivraison','', 'trim|required|min_length[1]|max_length[50]');
                 $this->form_validation->set_rules('paysl','', 'trim|required|min_length[1]|max_length[50]');
                 $this->form_validation->set_rules('villel','', 'trim|required|min_length[1]|max_length[50]');
                 $this->form_validation->set_rules('codepostall','', 'trim|required|min_length[1]|max_length[50]');
