                        ...
                        <div class="col-xs-6 col-md-offset-2">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                        ...
                                        <input  required="required" maxlength="100" type="text" class="form-control" placeholder="Entrer Numero Du telephone"  name="phone" />
                                    </div>
                                <div class="form-group">
                                    <label class="control-label">Numero Du Telephone Mobile </label>
                                    <input required="required" maxlength="100" type="text" class="form-control" placeholder="Entrer Numero Du telephone Mobile"  name="phoneMobile" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Numero Du Fax </label>
                                    <input required="required"  maxlength="100" type="text" class="form-control" placeholder="Entrer Numero Du Fax"  name="fax" />
                                </div>
                        ...
                        <div class="col-xs-6 col-md-offset-2">
                           <div class="col-md-12">
                               ...
                               <div class="form-group">
                                   ...
                                   <input required="required"  maxlength="100" type="date" class="form-control" placeholder="Entrer le Code postal"  name="codePostal" />
                               </div>
                               <div class="form-group">
                               ...
                               <div class="form-group">
                                   ...
                                   <input  required="required" maxlength="100" type="text" class="form-control" placeholder="Entrer Code APE"  name="ape" />
                               </div>
                    ...
                    <div class="row setup-content" id="step-3">
                        <div class="col-xs-6 col-md-offset-2">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Code Postal</label>
                                    <input  required="required" maxlength="100" type="text" class="form-control" placeholder="Code Postal"  name="codepostall" />
                                </div>
