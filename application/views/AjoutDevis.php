                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <?php if( empty($_SESSION['clientDevis'])){ ?>
                                                    <?php echo form_open('Devis/choisirClient','" id="form" class="form-horizontal"'); ?>
                                                    <div class="row">
                                                                            ...
                                                                            <div class="modal-dialog">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <?php echo form_open('Devis/AddDevis' , 'class="form-horizontal"'); ?>
                                                                                        <fieldset>
