...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Ajouter une Bon Commande
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('Dashboard/') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Ajouter un Bon De Commande </li>
        </ol>
    </section>
    <hr>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <?php if( empty($_SESSION['clientCommande'])){ ?>
                                                    <?php echo form_open('BonCommande/choisirClient','" id="form" class="form-horizontal"'); ?>
                                                    <div class="row">
                                                ...
                                                <?php }else{
                                                echo "Bon De Commande Pour  : ".$clientchoisi[0]->nom.' '.$clientchoisi[0]->prenom  ;
                                                ?>
                                                                            ...
                                                                            <div class="modal-dialog">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <?php echo form_open('BonCommande/AddBonCommande' , 'class="form-horizontal"'); ?>
                                                                                        <fieldset>
                                            ...
                                            <div class="col-md-12">
                                                <label class="col-md-2 control-label" for="submit"></label>
                                                <label class="col-md-2 control-label" for="submit"></label>
                                                <a href="<?php echo base_url('BonCommande/ajoutBonCommande');?>" class="btn  btn-success btn-lg">Ajouter Bon Commande</a>
                                                <a href="<?php echo base_url('BonCommande/annuler');?>" class="btn  btn-danger btn-lg">Annuler</a>
                                            </div>
