...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Liste Des Bon DE Commande </li>
        </ol>
    </section>
                    ...
                    <div class="dataTables_wrapper form-inline dt-bootstrap" >
                        <div class="row">
                            <table aria-describedby="example1_info" role="grid" id="example1" class="table results table-bordered table-striped dataTable">
                                <thead>
                                <tr role="row">
                                    <th aria-label="Numero Du Facture  : activate to sort column ascending" style="width: 105px;" colspan="1" rowspan="1" aria-controls="example1" tabindex="0" class="sorting">Numero Du Bon Commande</th>
                                ...
                                <tbody>
                                <?php foreach ($listBonCommande as $listebon){ ?>
                                    <tr>
                                        <td><a href="<?php echo base_url('BonCommande/AficherBonCommande/'.$listebon->numeroboncommande ) ; ?>"> <?php echo $listebon->numeroboncommande ?></a> </td>
                                        <td><?php echo $listebon->nom." ".$listebon->prenom ;?></td>
                                        <td> <a href="<?php echo base_url('BonCommande/Imprimer/'.$listebon->numeroboncommande); ?>">
                                                <i class="fa fa-print"></i></a>  </td>
                                        <?php if($_SESSION['isSysAdmin']==1){ ?>      <td> <a href="<?php echo base_url('BonCommande/suprimerBonCommande/'.$listebon->numeroboncommande); ?>">
