                                   ...
                                   <div class="panel panel-default">
                                       <div class="panel-body">
                                           <div class="form-group">
                                               <?php if( empty($_SESSION['clientbonliv'])){ ?>
                                                   <?php echo form_open('Bonlivraison/choisirClient','" id="form" class="form-horizontal"'); ?>
                                                   <div class="row">
                                                                           ...
                                                                           <div class="modal-dialog">
                                                                               ...
                                                                               <div class="modal-content">
                                                                                   ...
                                                                                   <div class="modal-body">
                                                                                       <?php echo form_open('Bonlivraison/addbonlivraison' , 'class="form-horizontal"'); ?>
                                                                                       <fieldset>
