...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Information Sur la Bon Commande Numero :<?php echo $clienbon[0]->numeroboncommande ; ?>
            </h1>
        ...
        <section class="content">
            <div class="panel">
                ...
                <center><a class="btn btn-primary btn-lg" href="<?php echo base_url('BonCommande/Imprimer/'.$clienbon[0]->numeroboncommande) ?>" >Imprimer </a></center>
